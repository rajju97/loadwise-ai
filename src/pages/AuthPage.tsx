...
export function AuthPage({ mode }: { mode: 'login' | 'register' }) {
  const { user, demoMode, signIn, signUp, enterDemo } = useAuth()
  ...
  function startDemo() { enterDemo(); navigate('/app') }
      ...
      <div className="auth-form-panel">
        <div className="auth-form-wrap">
          ...
          <form onSubmit={submit} className="auth-form">
            ...
            <label>Work email<div className="input-wrap"><Mail size={18} /><input required type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@company.com" /></div></label>
            ...
            {!isRegister && <div className="form-row"><label className="check-label"><input type="checkbox" /> Remember me</label><a href="#">Forgot password?</a></div>}
          ...
          <button className="button button-outline auth-submit" onClick={startDemo}>Explore demo workspace</button>
